...
module.createBtn = function(btnLabel, _ADTexture, buttonImg, _width, _height, _fontS, _background){
    let btn
    if(buttonImg){
        console.log("running")
...
module.createRowsOfText = function(_arrayOfText, _fontS, parentUI){
...
module.createGrid = function(parentUI, rowsSizesArray, columnSizesArray){
    const grid = new Ggrid("grid")
...
module.createRect = function(_childUI, _defWidthInNum,_defHeightInNum, _ADTexture, _cornerRadius,_background){
...
module.createTxt = function(_textLabel, _fontSize, _color){
...
module.createCheckBox = function(_label, _ADTexture,_isChecked, _callBWhenValueChanged, _bxSize, _fontS, _background, _isBxPositionLeft){
